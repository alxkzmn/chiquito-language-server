...
export async function activate(context: ExtensionContext) {
  ...
  const traceOutputChannel = window.createOutputChannel("Chiquito Language Server trace");
  const command = process.env.SERVER_PATH || "chiquito-language-server";
  ...
  let clientOptions: LanguageClientOptions = {
    ...
    documentSelector: [{ scheme: "file", language: "chiquito" }],
    synchronize: {
  ...
  client = new LanguageClient("chiquito-language-server", "Chiquito language server", serverOptions, clientOptions);
